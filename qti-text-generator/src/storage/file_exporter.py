...
class FileExporter:
    ...
    def export_batch(
        ...
        summary = {
            ...
            "question_type": "extended_text",  # 記述式問題であることを明示
            "total_questions": len(questions),
            "output_directory": batch_dir.name,
...
<qti-assessment-item identifier="text-test">
  <qti-item-body><p>テスト記述式問題</p></qti-item-body>
</qti-assessment-item>'''
    ...
    # 単一ファイル出力
    exporter.export_xml(test_xml, "test_text_item")
    exporter.export_json(test_question, "test_text_question")
